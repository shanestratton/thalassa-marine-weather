 ...
 * blank field — the blank field makes someone look it up. Every number below
 * already existed in this repo (components/passage/EmergencyPlan.tsx) rather
 * than being sourced fresh, and nothing here was guessed.
 *
 ...
 * contact page first, and say in the commit where it came from.
 */
export const MARINE_RESCUE_SERVICES: readonly MarineRescueService[] = [
    {
        ...
        phone: '1800 622 468',
        vhf: 'VHF 16',
        coverage: 'New South Wales coastal waters',
    ...
    },
    {
        ...
        phone: '07 3635 3600',
        vhf: 'VHF 16',
        coverage: 'Queensland coastal waters',
