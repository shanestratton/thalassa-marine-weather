...
export const MAJOR_BUOYS: BuoyStation[] = [
    ...
    { id: 'MB_Cent', name: 'Moreton Bay Central', lat: -27.25, lon: 153.2, type: 'bom' },
    { id: 'Spitfire', name: 'Spitfire Channel', lat: -27.05, lon: 153.25, type: 'bom' },
    { id: 'Rous', name: 'Rous Channel', lat: -27.38, lon: 153.4, type: 'bom' },
    { id: 'Banana', name: 'Banana Bank', lat: -27.5, lon: 153.3, type: 'bom' },
    ...
    { id: 'BananaAWS', name: 'Banana Bank (AWS)', lat: -27.5, lon: 153.3, type: 'bom-aws', bomStationId: '94591' },
    ...
    { id: '46050', name: 'Stonewall Bank (OR)', lat: 44.64, lon: -124.5, type: 'noaa' },
    ...
    { id: '44065', name: 'New York Harbor (NY)', lat: 40.37, lon: -73.7, type: 'noaa' },
    { id: '44009', name: 'Delaware Bay (DE)', lat: 38.46, lon: -74.7, type: 'noaa' },
    ...
    // --- UK & EUROPE ---
    { id: '62001', name: 'Gascogne (Biscay)', lat: 45.2, lon: -5.0, type: 'other' },
    { id: '62103', name: 'Channel Lightship (UK)', lat: 49.9, lon: -2.9, type: 'other' },
    { id: '62304', name: 'Sandettie Light (Dover)', lat: 51.15, lon: 1.8, type: 'other' },
    ...
    { id: 'M4', name: 'M4 Buoy (Donegal)', lat: 55.0, lon: -10.0, type: 'marine-ie' },
    ...
    { id: 'Waglan Island', name: 'Waglan Island (HKO)', lat: 22.18, lon: 114.3, type: 'hko' },
    { id: 'Cheung Chau', name: 'Cheung Chau (HKO)', lat: 22.2, lon: 114.03, type: 'hko' },
    ...
    { id: 'Adelaide', name: 'Adelaide (SA)', lat: -34.93, lon: 138.6, type: 'bom' },
    { id: 'Portland', name: 'Portland (VIC)', lat: -38.34, lon: 141.6, type: 'bom' },
