...
// The merge bound (count + register bytes) moved to mergeCap.ts — a pure
// module with the full kill-trail history — so the tracer's layer assembly
// can share it without importing this service's registry subscription.
