/**
 * Vercel serverless proxy for CMEMS sea-ice concentration binaries.
 * Sister to api/currents, api/waves, api/sst, api/chl.
 */
...
const RELEASE_BASE = 'https://github.com/shanestratton/thalassa-marine-weather/releases/download/cmems-seaice-latest';
