/**
 * Vercel serverless proxy for CMEMS chlorophyll binary assets.
 * Sister to api/currents, api/waves, api/sst.
 */
...
const RELEASE_BASE = 'https://github.com/shanestratton/thalassa-marine-weather/releases/download/cmems-chl-latest';
