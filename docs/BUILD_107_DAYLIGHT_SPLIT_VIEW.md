...
## Native delivery — 2026-09-09

Shane subsequently authorized getting 107 built and underway after both tasks finished. The source and embedded bundle were already built and synced; a fresh pre-archive check passed all **140 artifact contracts**. No app source was changed or rebuilt during archiving.

- Exact compiled source **75e3a901** passed [CI 34300472550](https://github.com/shanestratton/thalassa-marine-weather/actions/runs/34300472550), including all four jobs; the main check completed at **12:03 AEST**. [CodeQL 34300472565](https://github.com/shanestratton/thalassa-marine-weather/actions/runs/34300472565) and [Lighthouse 34300472627](https://github.com/shanestratton/thalassa-marine-weather/actions/runs/34300472627) also passed. Workspace HEAD `87f43910` differed from the compiled source only in this release document.
- Signed archive completed **12:04:41 AEST**, Xcode **26.6 (17F113)**: `/Users/shanestratton/Library/Developer/Xcode/Archives/2026-09-09/Thalassa-1.2.0-107-75e3a901.xcarchive`. Verified **1.2.0 (107)**, identifier `com.thalassa.weather`, iOS 17 minimum, the exact bundle/hash above, **419 archived public files** matching the native copy (417 production files plus two empty Capacitor/Cordova bridge files), **23 binaries with matching dSYMs**, no source maps, no embedded Watch or PlugIns, and strict/deep code-signature verification.
- Apple validation passed **12:07:34 AEST**: `method=validation`, `destination=upload`, `manageAppVersionAndBuildNumber=false` returned **Validated App / EXPORT SUCCEEDED**.
- Distribution export passed **12:08:47 AEST**: `/Users/shanestratton/Documents/Temporary Projects/Thalassa Releases/1.2.0-107-75e3a901/Thalassa Marine Weather.ipa`, SHA-256 **c7a8f0f95ab61474f3f674a74eb21caad16dc6dbb8557d3986094fa0fdec9bb7**. The exported app passed the same asset/dSYM identity checks and strict/deep signature verification; `get-task-allow=false`, APNs `production`, `beta-reports-active=true`, application identifier `D4TW8A23QZ.com.thalassa.weather`.
- **Upload accepted at 12:11:29 AEST**: Apple returned **Uploaded package is processing / Upload succeeded / Uploaded App / EXPORT SUCCEEDED**. The same validated archive was uploaded with automatic version/build management disabled. This receipt confirms upload, not completed processing or tester availability. Logs and the archive checker are in `/private/tmp/thalassa-build107.RrcQbN`. **Do not rebuild or reuse 107 after this upload.**
- Local What to Test notes: `/Users/shanestratton/Documents/Temporary Projects/Thalassa Releases/1.2.0-107-75e3a901/What-to-Test.txt`. This does not mean they have been submitted to App Store Connect.

TestFlight processing, internal-group availability, installation and the physical-device matrix remain separate checks. No Beta Skippers, public-link, yacht or production-service settings have been changed. Existing external-beta release gates remain in force.
