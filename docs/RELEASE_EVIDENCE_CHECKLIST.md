...
- [x] Bumped to 106 on every configuration, 2026-09-09 ≈08:50, source commit 7bcc62e6 (+ this bump). `VITE_APP_BUILD = 106` in CI vars still to set.
