...
- [ ] Verify 104 finishes processing and appears in the existing internal **Skipper** group. App Store Connect browser sign-in is required for this final delivery check; external beta access remains unchanged.
