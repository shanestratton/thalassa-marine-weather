 ...
 *
 * Targets the AMSA (Australian Maritime Safety Authority) vessel register.
 * Data source: AMSA Marine Safety API / Spatial Data Service.
 *
 * Endpoint: https://services.amsa.gov.au/  (Registered Ships dataset)
 * Format: JSON/GeoJSON from the AMSA Spatial Data Service (ArcGIS REST)
 *
 * The 2026 series "List of Registered Ships" is published as a searchable
 * spatial service. We query by MMSI to extract vessel name, type, call sign,
 * and dimensions.
 */

import { VesselMetadataRow, upsertMetadata } from '../supabase';

const AMSA_API_BASE = process.env.AMSA_API_URL || 'https://services.amsa.gov.au/arcgis/rest/services';
...
/**
 * Scrape vessel metadata from AMSA for a batch of Australian MMSIs.
 */
