...
export const VoyageChoiceDialog: React.FC<VoyageChoiceDialogProps> = React.memo(
    ({ onContinue, onNewVoyage, onCancel }) => (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-[9999] flex items-center justify-center p-4 modal-backdrop-enter">
            <div className="modal-panel-enter bg-slate-900 rounded-2xl border border-white/10 p-6 max-w-sm w-full shadow-2xl">
