...
export const TachGauge: React.FC<TachGaugeProps> = ({
    value,
    maxRpm = 4000,
    redline = 3200,
    freshness = 'dead'
        ...
        <div className="flex flex-col items-center justify-center w-full h-full gap-4">
            <div className="relative" style={{ width: '85vw', maxWidth: '360px', aspectRatio: '1' }}>
                <svg viewBox="0 0 300 300" className="w-full h-full">
                    ...
                    <path
                        ...
                        fill="none" stroke="rgba(34,197,94,0.12)" strokeWidth="16"
                    ...
                    <path
                        ...
                        fill="none" stroke="rgba(239,68,68,0.2)" strokeWidth="16"
                        strokeLinecap="butt" opacity={opacity}
                    />
                    ...
                    {isRedline && (
                        <path
                            ...
                            strokeLinecap="butt" filter="url(#redline-glow)"
                            ...
                            return (
                                <g key={rpm}>
                                    <line
                                        ...
                                        stroke={inRedzone
                                            ? (isMajor ? 'rgba(239,68,68,0.8)' : 'rgba(239,68,68,0.3)')
                                            : (isMajor ? 'rgba(255,255,255,0.5)' : 'rgba(255,255,255,0.15)')
                                        }
                    ...
                    {clamped !== null && (
                        ...
                        >
                            ...
                            {/* Needle body */}
                            <line x1={CX} y1={CY} x2={CX} y2={CY - RADIUS + 12}
                                stroke={isRedline ? '#ef4444' : '#e2e8f0'} strokeWidth="3" strokeLinecap="round"
                                filter="url(#tach-glow)"
                            />
                            {/* Needle tip */}
                            <circle cx={CX} cy={CY - RADIUS + 12} r="3"
                                fill={isRedline ? '#ef4444' : '#e2e8f0'} />
                        </g>
                    )}

                    {/* Center hub */}
                    <circle cx={CX} cy={CY} r="12" fill="rgba(15,23,42,0.95)"
                        stroke="rgba(255,255,255,0.2)" strokeWidth="2" opacity={opacity} />
                    <circle cx={CX} cy={CY} r="4"
                        fill={isRedline ? '#ef4444' : 'rgba(148,163,184,0.6)'} opacity={opacity} />

                    {/* ×1000 label */}
                    <text x={CX} y={CY + 45} textAnchor="middle"
                        fill="rgba(148,163,184,0.4)" fontSize="10" fontWeight="700"
                        fontFamily="system-ui" letterSpacing="0.1em" opacity={opacity}
                    >
                        ×1000 RPM
                    </text>
                </svg>
            ...
            <div className="flex flex-col items-center gap-1">
                <div className="flex items-baseline gap-1.5" style={{ opacity }}>
                    <span className={`text-6xl font-black tracking-tighter font-mono tabular-nums ${isRedline ? 'text-red-400' : 'text-white'}`}>
