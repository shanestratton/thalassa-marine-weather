...
export const BarGauge: React.FC<BarGaugeProps> = ({
    ...
    // Bar geometry
    const BAR_X = 30, BAR_Y = 120, BAR_W = 240, BAR_H = 24;
                ...
                <svg viewBox="0 0 300 200" className="w-full">
                    ...
                    <g opacity={opacity}>
                        {defaultZones.map((z, i) => {
                            ...
                            return (
                                <rect key={i}
                                    x={x1} y={BAR_Y} width={x2 - x1} height={BAR_H}
                                    rx={i === 0 ? 6 : 0} ry={i === 0 ? 6 : 0}
                                    fill={z.color} opacity={0.1}
                                />
                            );
                        })}
                    </g>
                    ...
                    {value !== null && fraction > 0.01 && (
                        <rect
                            x={BAR_X + 1} y={BAR_Y + 1}
                            width={(fraction * BAR_W) - 2} height={BAR_H - 2}
                            rx="5"
                            fill={currentColor} opacity={opacity * 0.6}
                    ...
                    {value !== null && (
                        <g opacity={opacity}>
                            <line
                                x1={BAR_X + fraction * BAR_W} y1={BAR_Y - 6}
                                x2={BAR_X + fraction * BAR_W} y2={BAR_Y + BAR_H + 6}
                            ...
                            {/* Value pip dot */}
                            <circle
                                cx={BAR_X + fraction * BAR_W} cy={BAR_Y - 10}
                    ...
                    <g opacity={opacity * 0.5}>
                        {defaultZones.map((z, i) => {
                            ...
                            return (
                                <text key={i} x={x} y={BAR_Y - 12}
                                    textAnchor="middle" fill={z.color} fontSize="8"
