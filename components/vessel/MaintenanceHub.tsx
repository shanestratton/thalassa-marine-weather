 ...
 *
 * Sub-components extracted to ./maintenance/:
 *   - SwipeableTaskCard: swipeable task card with traffic-light status
 *   - ServiceLogSheet: bottom sheet for logging maintenance
