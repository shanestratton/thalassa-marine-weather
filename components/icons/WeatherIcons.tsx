...
export const TideCurveIcon = ({ className }: { className?: string }) => (
    <svg
        ...
        className={className}
    >
        <path d="M22 12c-4 0-5-9-9-9s-5 9-9 9" />
        <path d="M22 17c-4 0-5-9-9-9s-5 9-9 9" opacity="0.5" />
    </svg>
);
...
export const CycloneIcon = ({ className }: { className?: string }) => (
    <svg
        ...
        className={className}
    >
        <path d="M20 20a2 2 0 0 0 2-2v-2a10 10 0 0 0-20 0v2a2 2 0 0 0 2 2" />
        <path d="M12 12a2 2 0 0 0-2 2v2a2 2 0 0 0 4 0v-2a2 2 0 0 0-2-2Z" />
        <path d="M12 12V2" />
    </svg>
);
