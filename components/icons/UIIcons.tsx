...
// ── New icons (Lucide-style) added during emoji → SVG migration ──
...
export const MuteIcon = ({ className }: { className?: string }) => (
    ...
    >
        ...
        <path d="M11 4.703a.704.704 0 0 0-1.204-.498L9 5" />
    </svg>
);
...
export const WalkIcon = ({ className }: { className?: string }) => (
    ...
    >
        ...
        <path d="m5 22 4-9 4 5-3 4" />
        <path d="m9 13 1-2 4-1 4 5 3-2" />
        <path d="m13 16-3 4" />
    </svg>
);

// 🗓️ 📅 — Calendar with grid. (CalendarIcon already exists in
// MaritimeIcons but with a different style; this one is the more
