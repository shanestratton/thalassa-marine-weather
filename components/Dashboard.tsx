...
export const Dashboard: React.FC<DashboardProps> = React.memo((props) => {
    ...
    return (
        <DashboardWidgetContext.Provider value={contextValue as DashboardWidgetContextType}>
                ...
                <div className="flex-1 relative w-full min-h-0">
                    ...
                    {!isDetailMode && (
                        <div className="absolute inset-0">
                            ...
                            <div className="flex-shrink-0 z-[120] w-full max-w-2xl mx-auto bg-gradient-to-b from-black/80 to-transparent px-4 pb-0 fixed left-0 right-0 pointer-events-none" style={{ top: 'calc(max(8px, env(safe-area-inset-top)) + 126px)' }}>
                            ...
                            <div className="fixed top-[0px] left-0 right-0 bg-black z-[100] transition-all duration-300 max-w-2xl mx-auto" style={{ height: isExpanded ? 'calc(max(8px, env(safe-area-inset-top)) + 420px)' : 'calc(max(8px, env(safe-area-inset-top)) + 340px)' }}></div>

                            {/* FIXED HEADER - Positioned 7px below CompactHeaderRow (126 + 40 + 7 = 173) */}
                            <div className="fixed left-0 right-0 z-[110] px-4 max-w-2xl mx-auto" style={{ top: 'calc(max(8px, env(safe-area-inset-top)) + 173px)' }}>
                                <HeroHeader
                                    data={safeActive}
                                    units={units}
                            ...
                            <div
                                className="fixed left-0 right-0 z-[110] px-4 max-w-2xl mx-auto transition-all duration-300 ease-in-out"
                                style={{
                            ...
                            */}
                            <div className="fixed left-0 right-0 z-[120] overflow-hidden bg-black transition-[top] duration-300 flex flex-col gap-[7px] pt-0 max-w-2xl mx-auto" style={{ top: isExpanded ? 'calc(max(8px, env(safe-area-inset-top)) + 420px)' : 'calc(max(8px, env(safe-area-inset-top)) + 340px)', bottom: 'calc(env(safe-area-inset-bottom) + 124px)' }}>
                            ...
                            {isExpanded && (
                                <div className="fixed left-0 right-0 z-[125] flex justify-center max-w-2xl mx-auto" style={{ bottom: 'calc(env(safe-area-inset-bottom) + 124px)' }}>
                            ...
                            */}
                            <div className="fixed left-0 right-0 z-[125] px-4 max-w-2xl mx-auto" style={{ bottom: 'calc(env(safe-area-inset-bottom) + 74px)' }}>
            ...
            {!showTutorial && showTooltips && (
                <OnboardingTooltips onComplete={dismissTooltips} />
            )}
