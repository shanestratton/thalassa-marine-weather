        ...
        >
            ...
            >
                ...
                <div className="px-5 py-4 space-y-3">
                    {/* Last Flight card RETIRED (Shane 2026-08-25) once the
                        Musgrave kills were solved — the flight recorder still
                        runs (utils/flightRecorder) and its verdict still
                        prints to the console for the next hunt; it just no
                        longer takes a card in the punter-facing Systems view. */}
