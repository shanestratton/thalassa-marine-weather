...
export const NavButton: React.FC<NavButtonProps> = ({ icon, label, active, onClick }) => (
    <button
        ...
        className={`relative z-50 cursor-pointer flex flex-col items-center justify-center w-14 h-full transition-colors duration-75 active:scale-95 touch-manipulation ${active ? 'text-sky-400' : 'text-gray-400 hover:text-gray-200 active:text-sky-300'}`}
