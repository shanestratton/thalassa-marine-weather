...
// The STATEFUL half — the per-map depth-style record, the paint appliers that
...
import {
    ...
    updateEncDepthStyle,
} from './encDepthStyleState';

// Public surface preserved by re-export: MapHub and useEncVectorLayer keep
// importing these from here, unchanged by the carve.
export {
    SATELLITE_HIDE_LAYERS,
    SATELLITE_KEY,
    setEncDraftAssumed,
