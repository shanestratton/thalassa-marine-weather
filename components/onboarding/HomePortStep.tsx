import React, { Suspense, useCallback, useId, useRef } from 'react';
...
export const HomePortStep: React.FC<HomePortStepProps> = ({
    ...
    const homePortInputId = useId();
    const mapTitleId = useId();
    const closeMap = useCallback(() => onShowMap(false), [onShowMap]);
    const mapDialogRef = useFocusTrap<HTMLDivElement>(showMap, {
