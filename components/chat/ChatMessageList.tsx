                    ...
                    {windowedMessages.map((msg, i) => {
                        ...
                        return (
                            <React.Fragment key={msg.id}>
                                {/* Date separator */}
                                {dateSep && (
                                    <div className="flex items-center gap-3 py-3" role="separator" aria-label={getDateLabel(msg.created_at)}>
                                        <span className="flex-1 h-px bg-gradient-to-r from-transparent to-white/[0.06]" />
                                        <span className="text-[11px] font-bold text-white/20 uppercase tracking-[0.15em]">{getDateLabel(msg.created_at)}</span>
