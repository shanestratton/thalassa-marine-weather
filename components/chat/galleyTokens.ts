...
export const STRIP_WORDS = new Set([
    'large', 'small', 'medium', 'fresh', 'dried', 'ground', 'whole', 'raw',
    'cooked', 'chopped', 'diced', 'sliced', 'minced', 'grated', 'shredded',
    'crushed', 'melted', 'softened', 'unsalted', 'salted', 'sharp', 'mild',
    'extra', 'fine', 'thick', 'thin', 'hot', 'cold', 'frozen', 'canned', 'tinned',
]);
