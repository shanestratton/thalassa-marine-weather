...
export const WeatherMap: React.FC<WeatherMapProps> = React.memo(
    ({
        lat,
        lon,
        locationName,
        ...
        const [pendingSelection, setPendingSelection] = useState<{ lat: number; lon: number; name: string } | null>(
            null,
        );
