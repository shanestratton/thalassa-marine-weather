        ...
        <div className="max-w-7xl mx-auto w-full animate-in fade-in slide-in-from-bottom-8 duration-700 pb-12 flex-1 flex flex-col gap-3">
            ...
            <div className="w-full p-4 bg-amber-950/20 border border-amber-900/30 rounded-xl flex items-start gap-4 shadow-lg">
                ...
                <div>
                    ...
                    <p className="text-[11px] text-amber-200/80 leading-relaxed font-medium">
                        This passage plan is generated using automated weather models and AI analysis. It is intended as
                        a navigational aid only and does not replace proper seamanship, official charts, or local
                        knowledge.
                        <span className="block mt-1.5 text-amber-100/90 font-bold">
                            The Master/Skipper is solely responsible for the safety of the vessel, crew, and all souls
                            on board. All navigation decisions remain the exclusive responsibility of the person in
                            command.
                        </span>
                    </p>
                </div>
            ...
            <div className="flex flex-col gap-3">
                ...
                <AccordionSection
                    ...
                    subtitle={
                        vessel.type === 'observer' ? 'Passage Distance & Duration' : 'Resource Requirements Calculator'
                    }
