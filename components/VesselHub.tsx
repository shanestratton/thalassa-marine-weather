...
export const VesselHub: React.FC<VesselHubProps> = React.memo(({ onNavigate, settings, onSave: _onSave }) => {
    ...
    useEffect(() => {
        // No specific passage selected, but still check crew count
    ...
    return (
        <div
            className="w-full h-full flex flex-col px-4 pt-4 animate-in fade-in duration-300 vessel-hub-no-scrollbar"
            style={{ paddingBottom: 'calc(4rem + env(safe-area-inset-bottom) + 8px)' }}
        >
            {/* Scrollable content area — shrinks to fill available space */}
            <div className="flex-1 min-h-0 overflow-y-auto vessel-hub-no-scrollbar">
                {/* ═══════════════════════════════════════════ */}
                ...
                <div className="mb-6">
                    ...
                    <div className="bg-gradient-to-br from-violet-500/10 to-fuchsia-500/10 border border-violet-500/20 rounded-xl p-4">
                        {/* Crew Management button — always visible */}
                        <button
            ...
            {/* ═══════════════════════════════════════════ */}
            {/* ZONE 3: APP ADMINISTRATION — pinned bottom */}
            {/* ═══════════════════════════════════════════ */}
