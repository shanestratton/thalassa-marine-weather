...
export const NotificationModal: React.FC<NotificationModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4" role="dialog" aria-modal="true" aria-labelledby="notification-title" ref={focusTrapRef}>
      {/* Backdrop */}
      <div
            ...
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400">Alert when wind exceeds</p>
                </div>
              </div>
            ...
            {localSettings.wind.enabled && (
              <div className="flex items-center space-x-2 mt-2 pl-12 animate-in fade-in slide-in-from-top-2 duration-300">
                <input
                  ...
                  className="w-20 bg-black/30 ${t.border.default} rounded-lg px-3 py-1.5 text-white text-sm focus:border-purple-500 outline-none"
                />
            ...
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400">Alert when waves exceed</p>
                </div>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input
            ...
            {localSettings.waves.enabled && (
              <div className="flex items-center space-x-2 mt-2 pl-12 animate-in fade-in slide-in-from-top-2 duration-300">
                <input
                  ...
                  className="w-20 bg-black/30 ${t.border.default} rounded-lg px-3 py-1.5 text-white text-sm focus:border-sky-500 outline-none"
                />
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400">Alert when raining or stormy</p>
                </div>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input
