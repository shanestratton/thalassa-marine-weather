            ...
            <div className={`modal-panel-enter bg-slate-900/90 backdrop-blur-xl ${t.border.default} rounded-2xl p-4 shadow-2xl relative`}>
                ...
                <div className="flex gap-4">
                    <div className="w-12 h-12 bg-sky-500 rounded-xl flex items-center justify-center shadow-lg shrink-0">
                        <img src="https://cdn-icons-png.flaticon.com/512/567/567055.png" alt="App Icon" className="w-8 h-8 invert brightness-0" loading="lazy" />
                    </div>
                    <div className="flex-1">
                        ...
                        <div className="flex items-center gap-2 mt-3 text-sm font-medium text-sky-400">
                            <span>Tap</span>
                            <ShareIcon className="w-4 h-4" />
                            <span>then</span>
                            <span className={`flex items-center gap-1 ${t.border.strong} px-1.5 py-0.5 rounded bg-white/5 text-white`}>
