                                ...
                                {isLoading ? (
                                    ...
                                    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                                        <div className="flex justify-between items-start mb-6 pr-10">
                                            <div>
                                                ...
                                                <p className="text-sm text-sky-300 font-medium mt-0.5">
                                                    {current.condition} • {current.airTemperature}°{units.temp}
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="grid grid-cols-3 gap-3 mb-6">
                                            <div
                                                className={`bg-white/5 rounded-2xl p-3 flex flex-col items-center justify-center text-center ${t.border.subtle}`}
                                            >
