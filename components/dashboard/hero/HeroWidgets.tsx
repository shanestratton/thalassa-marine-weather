            ...
            return (
                <div className={`flex flex-col h-full justify-end ${alignClass}`}>
                    ...
                    <div className="flex flex-wrap items-end gap-1">
                        <span className={`${valSize} md:text-5xl font-black tracking-tighter ${getSourceTextColor('windSpeed')}`}>{values.windSpeed}</span>
        ...
        case 'gust':
            return (
                <div className={`flex flex-col h-full justify-end ${alignClass}`}>
                    ...
                    <div className="flex flex-wrap items-end gap-1">
                        <span className={`${valSize} md:text-5xl font-black tracking-tighter ${getSourceTextColor('windGust')}`}>{values.gusts}</span>
                        <span className={`${subSize} md:text-sm font-medium text-gray-400 pb-1`}>{units.speed}</span>
        ...
        case 'wave':
            return (
                <div className={`flex flex-col h-full justify-end ${alignClass}`}>
                    ...
                    <div className="flex flex-wrap items-end gap-1">
                        <span className={`${valSize} md:text-5xl font-black tracking-tighter ${getSourceTextColor('waveHeight')}`}>{values.waveHeight}</span>
