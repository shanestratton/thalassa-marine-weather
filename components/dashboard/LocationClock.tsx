...
export const LocationClock = ({ timeZone, utcOffset }: { timeZone: string | undefined, utcOffset?: number }) => {
    ...
    return (
        <span className="text-ivory font-mono text-sm md:text-sm font-medium opacity-90 text-center flex flex-wrap justify-center gap-0.5 leading-tight tracking-tight">
