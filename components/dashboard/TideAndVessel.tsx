...
export const MoonVisual = ({ cloudCover, apiPhase, apiIllumination, apiPhaseValue, lat }: { cloudCover: number, apiPhase?: string, apiIllumination?: number, apiPhaseValue?: number, lat?: number }) => {
    // Local Calc Fallback
...
const SolarArc = ({ sunrise, sunset, showTimes = true, size = 'normal', timeZone }: { sunrise: string, sunset: string, showTimes?: boolean, size?: 'normal' | 'large', timeZone?: string }) => {
